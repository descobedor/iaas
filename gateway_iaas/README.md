...
Además expone una interfaz **Model Context Protocol (MCP)** vía JSON-RPC en `POST /mcp` para listar herramientas (`tools/list`) y ejecutar `extract_menu_text` con imágenes base64. La integración MCP usa **Spring AI MCP Server**.
